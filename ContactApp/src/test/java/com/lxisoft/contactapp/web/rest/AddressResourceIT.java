...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().placeName(DEFAULT_PLACE_NAME).countryName(DEFAULT_COUNTRY_NAME);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().placeName(UPDATED_PLACE_NAME).countryName(UPDATED_COUNTRY_NAME);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.placeName(UPDATED_PLACE_NAME).countryName(UPDATED_COUNTRY_NAME);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.countryName(UPDATED_COUNTRY_NAME);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.placeName(UPDATED_PLACE_NAME).countryName(UPDATED_COUNTRY_NAME);
