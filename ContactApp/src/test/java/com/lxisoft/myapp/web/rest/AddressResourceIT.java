...
import com.lxisoft.myapp.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().placeName(DEFAULT_PLACE_NAME).country(DEFAULT_COUNTRY);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().placeName(UPDATED_PLACE_NAME).country(UPDATED_COUNTRY);
        return address;
    }
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getPlaceName()).isEqualTo(DEFAULT_PLACE_NAME);
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.placeName(UPDATED_PLACE_NAME).country(UPDATED_COUNTRY);
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getPlaceName()).isEqualTo(UPDATED_PLACE_NAME);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.placeName(UPDATED_PLACE_NAME).country(UPDATED_COUNTRY);
