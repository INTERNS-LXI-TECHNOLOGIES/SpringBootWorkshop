...
public class FirmResourceIT {
    ...
    public void createFirm() throws Exception {
        ...
        assertThat(testFirm.getStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    @Test
    @Transactional
    public void checkPhNumberIsRequired() throws Exception {
        int databaseSizeBeforeTest = firmRepository.findAll().size();
        // set the field null
        firm.setPhNumber(null);
    ...
    public void updateFirm() throws Exception {
        ...
        assertThat(testFirm.getStatus()).isEqualTo(UPDATED_STATUS);
    }
