...
public class FirmResource {
     ...
     */
    @PostMapping("/firms")
    public ResponseEntity<Firm> createFirm(@RequestBody Firm firm) throws URISyntaxException {
     ...
     */
    @PutMapping("/firms")
    public ResponseEntity<Firm> updateFirm(@RequestBody Firm firm) throws URISyntaxException {
