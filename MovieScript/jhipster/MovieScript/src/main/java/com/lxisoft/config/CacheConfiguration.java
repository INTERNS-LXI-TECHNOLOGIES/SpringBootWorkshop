...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.lxisoft.domain.Movie.class.getName());
            createCache(cm, com.lxisoft.domain.Movie.class.getName() + ".actors");
            createCache(cm, com.lxisoft.domain.Movie.class.getName() + ".scenes");
            createCache(cm, com.lxisoft.domain.Scene.class.getName());
            createCache(cm, com.lxisoft.domain.Actor.class.getName());
            createCache(cm, com.lxisoft.domain.Actor.class.getName() + ".dialogues");
            createCache(cm, com.lxisoft.domain.Character.class.getName());
            createCache(cm, com.lxisoft.domain.Dialogue.class.getName());
