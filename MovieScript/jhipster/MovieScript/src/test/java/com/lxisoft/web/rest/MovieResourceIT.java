...
public class MovieResourceIT {
    ...
    private static final String DEFAULT_MOVIE_DETAILS = "AAAAAAAAAA";
    private static final String UPDATED_MOVIE_DETAILS = "BBBBBBBBBB";
    ...
    public static Movie createEntity(EntityManager em) {
        Movie movie = new Movie()
            ...
            .movieDetails(DEFAULT_MOVIE_DETAILS);
        return movie;
    }
    /**
    ...
    public static Movie createUpdatedEntity(EntityManager em) {
        Movie movie = new Movie()
            ...
            .movieDetails(UPDATED_MOVIE_DETAILS);
        return movie;
    }
    ...
    public void createMovie() throws Exception {
        ...
        assertThat(testMovie.getMovieDetails()).isEqualTo(DEFAULT_MOVIE_DETAILS);
    }
    ...
    public void getAllMovies() throws Exception {
        ...
        restMovieMockMvc.perform(get("/api/movies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].movieDetails").value(hasItem(DEFAULT_MOVIE_DETAILS)));
    }
    ...
    public void getMovie() throws Exception {
        ...
        restMovieMockMvc.perform(get("/api/movies/{id}", movie.getId()))
            ...
            .andExpect(jsonPath("$.movieDetails").value(DEFAULT_MOVIE_DETAILS));
    }
    @Test
    @Transactional
    ...
    public void updateMovie() throws Exception {
        ...
        assertThat(testMovie.getMovieDetails()).isEqualTo(UPDATED_MOVIE_DETAILS);
    }
